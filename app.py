...
STOCKS = (
    "IBN", "SBIN.NS","PARADEEP.NS", "RELIANCE.NS", "HINDUNILVR.NS", "INFY", "BAJFINANCE.NS", 
    "LICI.NS", "ITC.NS", "LT.NS", "MARUTI.NS", "M&M.NS", "HCLTECH.NS", 
    "KOTAKBANK.NS", "SUNPHARMA.NS", "ULTRACEMCO.NS", "AXISBANK.BO", "TITAN.NS", 
    "NTPC.NS", "BAJAJFINSV.NS", "DMART.NS", "ONGC.NS", "HAL.NS", "ADANIPORTS.NS", 
    "BEL.NS", "POWERGRID.NS", "WIT", "ADANIENT.NS", "JSWSTEEL.NS", "BAJAJ-AUTO.NS", 
    "ASIANPAINT.NS", "COALINDIA.NS", "HDB", "ADANIPOWER.NS", "NESTLEIND.NS", 
    ...
    "HEROMOTOCO.NS", "CUMMINSIND.NS", "RDY", "MANKIND.NS", "JINDALSTEL.NS", 
